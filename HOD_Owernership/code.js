...
const SHEET_QUESTIONS = 'HOD_Ownership_Question';
const SHEET_RESPONSES = 'HOD_Ownership_Responses';

// ---------------- Notification config ----------------
const FORM_TYPE       = 'Ownership';
...
const TPL_HOD_COL     = 'Ownership_Response_mail_template';
const TPL_EMP_COL     = 'Employee_Ownership_response_mail_template';

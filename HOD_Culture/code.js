...
const SHEET_QUESTIONS = 'HOD_Culture_Question';
const SHEET_RESPONSES = 'HOD_Culture_Responses';

// ---------------- Notification config ----------------
const FORM_TYPE       = 'Culture';
 // 'Culture' | 'Ownership' | 'Accountability'  ← change per clone
...
const TPL_HOD_COL     = 'Culture_Response_mail_template';
const TPL_EMP_COL     = 'Employee_culture_response_mail_template';
